...
import { JUDGE_V2_PROMPT } from "../prompts.js";
...
export async function callJudgeV2(query: string, trajectory: Trajectory): Promise<JudgeResult> {
  const prompt = JUDGE_V2_PROMPT
    .replace("{query}", query)
